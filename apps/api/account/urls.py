...
urlpatterns = [
    ...
    url(r'^(?P<id>[0-9a-f-]+)/$',                           views.UserAccountByIdAPIView.as_view(), name='account-by-id'),
    url(r'^(?P<id>[0-9a-f-]+)/follow/$',                    views.UserAccountFollowAPIView.as_view(), name='account-follow'),
    url(r'^following/page=(?P<page>\d+)$',                  views.UserAccountFollowingsAPIView.as_view(), name='account-followings'),
    url(r'^(?P<id>[0-9a-f-]+)/posts/page=(?P<page>\d+)$',   views.UserPostListAPIView.as_view(), name='user-posts'),
