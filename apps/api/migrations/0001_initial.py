# -*- coding: utf-8 -*-
# Generated by Django 1.11.15 on 2018-12-21 07:46
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='message',
            name='first',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='first_messager', to='api.UserAccount'),
        ),
        migrations.AddField(
            model_name='message',
            name='room',
        ...
        migrations.AddField(
            model_name='message',
            name='second',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='second_messager', to='api.UserAccount'),
        ),
        migrations.AddField(
            model_name='chatroom',
            name='first',
